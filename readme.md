...
2. Dentro do ambiente virtual, execute `django-admin startproject your_project_name . --extension py,json --template=https://github.com/citiufpe/citi-webplate/archive/master.zip`;
